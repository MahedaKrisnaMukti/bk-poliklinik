    ...
    <div class="col-xl-12 col-md-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="formSubmit" method="POST" action="/admin/obat/{{ Crypt::encrypt($medicine->id) }}"
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control" name="name" id="name"
                            value="{{ $medicine->name }}" placeholder="Masukan Nama" autocomplete="off">
                    </div>
                    ...
                    <div class="mb-1">
                        ...
                        <select class="form-control select2" name="packaging" id="packaging">
                            <option value="{{ $medicine->packaging }}">
                                {{ $medicine->packaging }}
                            </option>
